 ...
 <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      <div class="container-fluid">
       ...
       <a href="tambah_user.php" class="btn btn-primary">TAMBAH DATA <i class="nav-icon fas fa-plus"></i> </a>  
    </div>
           <!-- /.card-header -->
              <div class="card-body">
          ...
          while($data = mysqli_fetch_assoc($sql))
          {
            ...
            <tr>
             ...
             <td>'.$data['role'].'</td>
              ...
              <td>
                <a href="edit_user.php?id_user='.$data['id_user'].'" class="badge badge-warning">Edit</a>
                <a href="delete_user.php?id_user='.$data['id_user'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
              </td>
            </tr>
            ';
            $no++;
