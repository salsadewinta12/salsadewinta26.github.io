  ...
  <div class="content-wrapper">
   <section class="content">
      <div class="container-fluid">
        ...
        <h2>FORM OUTLET</h2>
    <hr>
    <form action="simpan_outlet.php" method="post">
        <div class="form-group row">
        <label class="col-sm-2 col-form-label">ID_OUTLET</label>
        <div class="col-sm-10">
          <input type="text" name="id_outlet" class="form-control" readonly="readonly" required >
        </div>
        </div>
        <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <a class='btn btn-danger' href='outlet.php'>Batal</a>
        </div>
      </div>
    </form>
        </div>
