...
<head>
  ...
  <title>Modern-Wash| Dashboard</title>
 ...
 <!-- Main Sidebar Container -->
  ...
  <section class="content">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header">
                <a href="tambah_outlet.php" class="btn btn-primary">TAMBAH DATA <i class="nav-icon fas fa-plus"></i> </a>  
             </div>
           <!-- /.card-header -->
              <div class="card-body">
      ...
      <tbody>
        ...
        $sql = mysqli_query($kon, "SELECT * FROM tb_outlet") or die(mysqli_error($kon));
        ...
        if(mysqli_num_rows($sql) > 0)
        {
          ...
          while($data = mysqli_fetch_assoc($sql))
          {
            ...
            <tr>
             ...
             <td>'.$data['tlp'].'</td>
              <td>
                <a href="edit_outlet.php?id_outlet='.$data['id_outlet'].'" class="badge badge-warning">Edit</a>
                <a href="delete_outlet.php?id_outlet='.$data['id_outlet'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
              </td>
            </tr>
            ';
            $no++;
