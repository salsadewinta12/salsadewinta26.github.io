...
<div class="wrapper">
  ...
  <section class="content">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="tambah_member.php" class="btn btn-primary">TAMBAH DATA <i class="nav-icon fas fa-plus"></i> </a>  
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <tbody>
        ...
        $sql = mysqli_query($kon, "SELECT * FROM tb_member") or die(mysqli_error($kon));
        ...
        if(mysqli_num_rows($sql) > 0)
        {
          ...
          while($data = mysqli_fetch_assoc($sql))
          {
            ...
            <tr>
             ...
             <td>'.$data['tlp'].'</td>
              <td>
                <a href="edit_member.php?id_member='.$data['id_member'].'" class="badge badge-warning">Edit</a>
                <a href="delete_member.php?id_member='.$data['id_member'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
              </td>
            </tr>
            ';
            $no++;
