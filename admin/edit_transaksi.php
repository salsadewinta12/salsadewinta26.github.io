...
$username=$_SESSION["username"];
  ...
  $select = mysqli_query($kon, "SELECT * FROM tb_transaksi WHERE id_transaksi='$id_transaksi'") or die(mysqli_error($kon));
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
      <div class="container-fluid">
        ...
        <div class='form'><form method='post' action='update_transaksi.php' class='cmxform form-horizontal tasi-form' id='commentForm'>
      <div class="form-group ">
        <label class="col-sm-2 col-form-label">ID</label>
        <div class="col-sm-10">
          <input type="text" name="id_transaksi" class="form-control" size="4" value="<?php echo $data['id_transaksi']; ?>" readonly="readonly" required>
        </div>
      </div>
         <div class='form-group'>
          ...
          <div class='col-lg-10'>
            <select class='form-control' name="dibayar" value="<?php echo $data['dibayar']; ?>">
