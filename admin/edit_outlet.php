...
$username=$_SESSION["username"];
  ...
  $select = mysqli_query($kon, "SELECT * FROM tb_outlet WHERE id_outlet='$id_outlet'") or die(mysqli_error($kon));
   ...
   <section class="content">
    ...
    <form action="update_outlet.php" method="post">
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">ID_OUTLET</label>
        <div class="col-sm-10">
          <input type="text" name="id_outlet" class="form-control" size="4" value="<?php echo $data['id_outlet']; ?>" readonly="readonly" required>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <a href="outlet.php" class="btn btn-warning">KEMBALI</a>
        </div>
      </div>
    </form>
        </div>
