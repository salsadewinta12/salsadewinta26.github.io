  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/d.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
            <a href="detail_transaksi.php" class="nav-link active">
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
      ...
      <thead class="thead-dark">
        <tr>
           <th><i class='icon-terminal'></i> No</th>
            ...
            <th><i class='icon-signal'></i> ID Transaksi</th>
            <th><i class='icon-terminal'></i> ID Paket</th>
            <th><i class='icon-signal'></i> Berat (kg)</th>
            <th><i class='icon-signal'></i> Keterangan (Harga)</th>
      ...
      <tbody>
        ...
        $sql = mysqli_query($kon, "SELECT * FROM tb_detail_transaksi") or die(mysqli_error($kon));
        ...
        if(mysqli_num_rows($sql) > 0)
        {
          ...
          while($data = mysqli_fetch_assoc($sql))
          {
            ...
            <tr>
              ...
              <td>
                <a href="cetak.php?id='.$data['id'].'" class="badge badge-warning">cetak</a>
                <a href="delete_detail_transaksi.php?id='.$data['id'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
              </td>
            </tr>
            ';
            $no++;
