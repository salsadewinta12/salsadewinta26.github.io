...
<!-- Main Sidebar Container -->
  ...
  <section class="content">
      <div class="container-fluid">
       ...
       <a href="tambah_transaksi.php" class="btn btn-primary">TAMBAH DATA <i class="nav-icon fas fa-plus"></i> </a>  
          </div>
           <!-- /.card-header -->
              <div class="card-body">
      ...
      <tbody>
        ...
        $sql = mysqli_query($kon, "SELECT * FROM tb_transaksi") or die(mysqli_error($kon));
            ...
            <tr>
             ...
             <td>'.$data['biaya_tambahan'].'</td>
              <td>'.$data['diskon'].'</td>
               ...
               <td>'.$data['id_user'].'</td>
              <td>
                <a href="edit_transaksi.php?id_transaksi='.$data['id_transaksi'].'" class="badge badge-warning">Edit</a>
                <a href="delete_transaksi.php?id_transaksi='.$data['id_transaksi'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
              </td>
            </tr>
            ';
            $no++;
