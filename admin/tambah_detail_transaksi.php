...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="cetak.php">CETAK KARTU</a></li>
    ...
    <!-- /.content-header -->
   <div class='form'><form method='post' action='simpan_detail_transaksi.php' class='cmxform form-horizontal tasi-form' id='commentForm'>
                          ...
                          <select class="form-control" name="id_paket" required >
                              <option>ID Paket</option>
                                  <?php
                                      ...
                                      {
                                    ?>
                              <option> <?php echo $data['id_paket']; ?> </option>
                                     <?php
                                      } 
                                    ?>
                          </select>
             ...
             <div class='form-group'>
                  ...
                  <a class='btn btn-danger' href='detail_transaksi.php'>Batal</a>
                  </div>
              </div>
              </form>
              </div>
