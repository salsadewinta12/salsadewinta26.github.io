      ...
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            <div class="text-wrap p-4 p-lg-5  text-center d-flex align-items-center " style="background-image: url(dist/img/d.png);">
            ...
            <div class="login-wrap p-4 p-lg-5 order-md-last">
              <div class="d-flex">
                <div class="w-100">
                 <CENTER> <h3 class="mb-4">AREA LOGIN</h3></CENTER>
                </div>
                <div class="w-100">
